        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fighter1 = table.Column<string>(nullable: true),
                    Fighter2 = table.Column<string>(nullable: true),
                    Odds1 = table.Column<int>(nullable: false),
                    Odds2 = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClosingDate = table.Column<DateTime>(nullable: true),
                    Fight = table.Column<int>(nullable: false),
                    Odds = table.Column<int>(nullable: false),
                    Open = table.Column<bool>(nullable: false),
                    Pick = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bet_Fight_Fight",
                        column: x => x.Fight,
                        principalTable: "Fight",
                        principalColumn: "FightId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bet_AspNetUsers_User",
                        column: x => x.User,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
